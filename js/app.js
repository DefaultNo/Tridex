 ...
 */
            (function webpackUniversalModuleDefinition(root, factory) {
                ...
                return function() {
                    var __webpack_modules__ = {
                        686: function(__unused_webpack_module, __webpack_exports__, __nested_webpack_require_623__) {
                            "use strict";
                            ...
                            var ClipboardActionCopy = function ClipboardActionCopy(target) {
                                ...
                                var selectedText = "";
                                if ("string" === typeof target) selectedText = fakeCopyAction(target, options); else if (target instanceof HTMLInputElement && ![ "text", "search", "url", "tel", "password" ].includes(null === target || void 0 === target ? void 0 : target.type)) selectedText = fakeCopyAction(target.value, options); else {
                            ...
                            var ClipboardActionDefault = function ClipboardActionDefault() {
                                ...
                                var _options$action = options.action, action = void 0 === _options$action ? "copy" : _options$action, container = options.container, target = options.target, text = options.text;
                                if ("copy" !== action && "cut" !== action) throw new Error('Invalid "action" value, use either "copy" or "cut"');
                                if (void 0 !== target) if (target && "object" === _typeof(target) && 1 === target.nodeType) {
                                ...
                                if (target) return "cut" === action ? actions_cut(target) : actions_copy(target, {
                                    container
                                });
                            };
                            ...
                            function clipboard_typeof(obj) {
                                "@babel/helpers - typeof";
                                if ("function" === typeof Symbol && "symbol" === typeof Symbol.iterator) clipboard_typeof = function _typeof(obj) {
                                    return typeof obj;
                            ...
                            var Clipboard = function(_Emitter) {
                                ...
                                _createClass(Clipboard, [ {
                                    ...
                                    value: function isSupported() {
                                        ...
                                        var actions = "string" === typeof action ? [ action ] : action;
                        ...
                        438: function(module, __unused_webpack_exports, __nested_webpack_require_15749__) {
                            ...
                            function delegate(elements, selector, type, callback, useCapture) {
                                if ("function" === typeof elements.addEventListener) return _delegate.apply(null, arguments);
                                if ("function" === typeof type) return _delegate.bind(null, document).apply(null, arguments);
                                if ("string" === typeof elements) elements = document.querySelectorAll(elements);
    ...
    (() => {
        ...
        let slider = document.querySelector(".calculate-tarif__range-input");
        if (slider) {
            const currentPrice = document.querySelector(".calculate-tarif__range-price span");
            const totalPrice = document.querySelector(".footer-calculate__total-price span");
            const dailyPrice = document.querySelector(".footer-calculate__daily-price span");
            ...
            slider.noUiSlider.on("update", ((value, handle) => {
                currentPrice.textContent = value[0];
                totalPrice.textContent = value[0];
                dailyPrice.textContent = value[0];
            }));
        }
        ...
        function initSliders() {
            if (document.querySelector(".top-withdrawal")) new core(".top-withdrawal__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".top-withdrawal .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-withdrawal .controls-slider__button_prev",
                    nextEl: ".top-withdrawal .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".top-my-deposit__cards")) new core(".top-my-deposit__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".top-my-deposit .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-my-deposit .controls-slider__button_prev",
                    nextEl: ".top-my-deposit .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".balance-account__cards")) new core(".balance-account__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".balance-account .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".balance-account .controls-slider__button_prev",
                    nextEl: ".balance-account .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".top-deposit__cards")) new core(".top-deposit__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".top-deposit .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-deposit .controls-slider__button_prev",
                    nextEl: ".top-deposit .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".top-history__cards")) new core(".top-history__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".top-history__controls .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-history__controls .controls-slider__button_prev",
                    nextEl: ".top-history__controls .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".top-referral__cards")) new core(".top-referral__cards", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                speed: 800,
                pagination: {
                    el: ".top-referral__controls .controls-slider__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".top-referral__controls .controls-slider__button_prev",
                    nextEl: ".top-referral__controls .controls-slider__button_next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
        ...
        const copyButtons = document.querySelectorAll(".copy-item");
        if (copyButtons) copyButtons.forEach((item => {
            new clipboard(item);
        ...
        const esm = flatpickr;
        if (document.querySelector(".date-picker__input")) esm(".date-picker__input", {
            mode: "range",
            dateFormat: "j M y",
            defaultDate: [ "today", "today" ]
        });
        const burgerTarget = document.querySelector(".header__burger");
        const menu = document.querySelector(".menu");
        if (burgerTarget) burgerTarget.addEventListener("click", (() => {
            menu.classList.toggle("_active");
            burgerTarget.classList.toggle("_active");
            document.body.classList.toggle("lock");
        }));
        const languageMenu = document.querySelector(".language-menu");
        if (languageMenu) languageMenu.addEventListener("click", (() => {
            languageMenu.classList.toggle("_active");
        }));
        if (document.querySelector(".navigation")) {
            const navigationTarget = document.querySelector(".navigation__header-burger");
            const openNavigation = document.querySelector(".navigation-target");
            const wrap = document.querySelector(".wrap");
            const overlay = document.querySelector(".overlay-bg");
            navigationTarget.addEventListener("click", (() => {
                wrap.classList.toggle("_nav-close");
            }));
            openNavigation.addEventListener("click", (() => {
                wrap.classList.remove("_nav-close");
            }));
            overlay.addEventListener("click", (() => {
                wrap.classList.add("_nav-close");
            }));
        }
        if (document.querySelector(".bottom-deposit__block")) {
            const blocks = document.querySelectorAll(".bottom-deposit__block");
            ...
            blocks.forEach((item => {
                item.addEventListener("click", (() => {
                    clearDeposit();
                    item.closest(".bottom-deposit__block").classList.add("_active");
                }));
            }));
        }
        if (document.querySelector(".cards-balance__item")) {
            const cards = document.querySelectorAll(".cards-balance__item");
            function clearCards() {
                cards.forEach((card => {
                    card.closest(".cards-balance__slide").classList.remove("_active");
                }));
            }
            cards.forEach((card => {
                card.addEventListener("click", (e => {
                    clearCards();
                    card.closest(".cards-balance__slide").classList.add("_active");
                }));
            }));
        }
        if (document.querySelector(".plans-account__item")) {
            const blocks = document.querySelectorAll(".plans-account__item");
            function clearDeposit() {
                blocks.forEach((block => {
                    block.classList.remove("_active");
                }));
            ...
            blocks.forEach((item => {
                item.addEventListener("click", (() => {
                    clearDeposit();
                    item.closest(".plans-account__item").classList.add("_active");
                }));
            }));
        }
        pageNavigation();
